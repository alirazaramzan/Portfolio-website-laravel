...
@section('content')
    ...
    <section class="hero d-flex align-items-center text-center" style="margin-top: 80px;">
        <div class="container">
            <img src="{{ asset('images/profile-pic1.png') }}" alt="Ali Raza" class="rounded-circle mb-3" width="130">
            ...
            <a href="{{ route('testimonials') }}" class="btn btn-outline-dark mt-3">Testimonials →</a>
        </div>
    </section>
@endsection
